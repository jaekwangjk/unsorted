...
%% Hyper parameters 
N=200; % may be number of grain 
dims=[512 512]; % dimensions of grid 
...
fileName1 = './png/GrainSnapshot_';
%for t = 1:299% Main time iteration starts.
for t = 1:301% Main time iteration starts.
    ...
    % do not use this. This is nasty fucntion 
